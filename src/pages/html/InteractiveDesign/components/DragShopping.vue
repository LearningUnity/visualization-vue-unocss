...
<template>
  <div por w-full>
    <!-- src\pages\html\InteractiveDesign\components\CropImage.vue -->
    <div poa t-5px w-full text-center z-10 c="#fff">
      <p>div启用拖拽功能draggable="true", 监听 @dragstart, 设置要传输的数据</p>
      <p>商店div 监听 @dragover @dragleave 控制红框显示, 监听 @drop 获取数据并更新商店 </p>
      <p>通过DragEvent.dataTransfer传输数据</p>
    </div>
    <div class="container">
