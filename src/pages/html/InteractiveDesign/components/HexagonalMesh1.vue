...
<template>
  <div por w-full>
    <!-- src\pages\html\InteractiveDesign\components\HexagonalMesh1.vue -->
    <div poa t-20px w-full text-center z-10 c="#fff">
      <p>边的颜色: 背景色定时变化, item之间的margin留空, 看起来像是边的颜色</p>
      <p>item的形状: clip-path </p>
    </div>
    <div por w-full h-555px overflow-hidden>
...
.container {
  ...
  background: radial-gradient(circle at var(--xPos) var(--yPos),
      transparent 0,
      transparent 50px,
      #000 150px,
      #000 1000px);
