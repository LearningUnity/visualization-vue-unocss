<template>
  <div por w-full>
    <!-- src\pages\html\VisualDesign\components\SudokuImageAnimation.vue -->
    <div poa t-5px w-full text-center c="#000">
      不规则形状: border-radius(44% 56% 65% 35% / 57% 58% 42% 43%); 阴影: box-shadow; before/after伪元素添加小圆
    </div>
    <div class="container">
      <div class="content">
        <div class="drop">
