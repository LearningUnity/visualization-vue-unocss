<template>
  <div por w-full>
    <!-- src\pages\html\VisualDesign\components\HarmonyLogo.vue -->
    <div poa t-20px w-full text-center z-10 c="#fff">
      <p>top-after:上半部分光圈背景; top-before:上半部分光圈</p>
      <p>filter/box-shadow 实现中间线</p>
      <p>bottom-after:下半部分光圈背景; bottom-before:下半部分光圈(增加blur模糊处理)</p>
      <p>通过对bottom进行svg filter, 实现流动效果</p>
    </div>
    <div class="container">
      <div class="content">
        <div class="top">
