...
<template>
  <div por w-full>
    <!-- src\pages\html\VisualDesign\components\AnnulusProgressBar.vue -->
    <div poa t-20px w-full text-center c="#fff">
      box-shadow绘制凹槽背景, svg环形进度条
    </div>
    <div class="container" fccc w-full h-360px bg-linear-gradient="to-right,#04182c, #000c17, #04182c">
      <div class="content" frcc wh-230px bdr-rd-20px bdr-w-1px bdr-s-solid bdr-c="#fff" shadow="0px,20px,30px,#6483B120">
        <div class="box">
          <!-- 沟槽背景 -->
          ...
          <!-- 进度条百分比 -->
          <div poacc fs-30px c="#497241">{{ `${Math.floor(progress)}%` }}</div>
        </div>
      </div>
    </div>
  </div>
