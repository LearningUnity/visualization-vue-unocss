...
<template>
  <div por w-full>
    <p poa tl-0 opacity-50 z-2>TextOutlineAnimation1</p>
    <p poa t-50px w-full text-center fs-12px z-2 c="#1cbafb">
      ● 3个svg path, 3个动画 <br>
      ● stroke-dasharray 线段长度; stroke-dashoffset 线段开始位置; <br>
      ● 动画: 填充文字(fill: #fff) → 取消填充文字 → 文字完整 → 消失 → 文字完整 → 填充文字 <br>
    </p>
    <div class="container">
      <ModuleTitle i18nTitle="page.cssDynamicEffect.richDynamicEffect.textLineDisplay" />
      <div class="content" ref="conetentRef">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="188" height="70"
          viewBox="0 0 188 70" fill="none">
          <path id="S" style="stroke:#FFFFFF; stroke-width:1; stroke-opacity:1; stroke-dasharray:0 0"
          ...
          <path id="V" style="stroke:#FFFFFF; stroke-width:1; stroke-opacity:1; stroke-dasharray:0 0"
          ...
          <path id="G" style="stroke:#FFFFFF; stroke-width:1; stroke-opacity:1; stroke-dasharray:0 0"
