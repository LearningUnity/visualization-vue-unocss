...
<template>
  <div por w-full>
    <p poa tl-0 opacity-50>FlopTime/index</p>
    <p poa t-50px w-full text-center fs-12px c="#1cbafb">
      ● 每个数字的上下用伪元素before与after实现 <br>
      ● 下翻高亮使用box-shadow/backface-visibility实现 <br>
      ● 翻牌动画使用perspective/transform实现 <br>
    </p>
    <div class="container">
