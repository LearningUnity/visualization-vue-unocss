...
<template>
  <div por w-full>
    <p poa tl-0 opacity-50 z-2>MobiusBand2</p>
    <p poa t-50px w-full text-center fs-12px z-2 c="#1cbafb">
      ● 颜色变化: content: hue-rotate(0deg)<br>
      ● 每个点由span实现 <br>
      ● 点的大小变化: transform: scale(1→0.1) <br>
      ● 点的阴影: box-shadow <br>
    </p>
    <div class="container">
      <ModuleTitle i18nTitle="page.cssDynamicEffect.richDynamicEffect.mobiusRingsCircleDots" />
      <div class="content">
        <div class="circle">
