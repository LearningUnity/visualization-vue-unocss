...
<template>
  <div h-full bg-gradient-to-b from="#001529ee" to="#001529">
    <div ref="containerRef" fcs mb-20px max-h-full overflow-auto sb-w-8px sbt-w-8px sb-rd-4px sbt-rd-4px sb-bgc="#444444"
      sbt-bgc="#999999">
      <!-- 顶部按钮 -->
      <div mx-8px my-16px>
      ...
      <!-- 底部描述 -->
      <p v-if="!collapsed" mt-10px mb-20px w-full fs-14px c="#a84448" fw-400 text-center>
        {{ t("common.keepUpdating") }}
      </p>
    </div>
  </div>
</template>
